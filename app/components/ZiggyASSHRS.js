...
export default class ZiggyASHS extends React.Component {
  static navigationOptions = {
    title: '10|10|10|5  Dam +9',
  };
  constructor(props) {
    super(props);
  imgClick = () => {
    Alert.alert(
  'Column 1 Base D20 roll \n \nColumn 2 D20 \n + 10|10|10|5 \n Song/Haste/Rapid Shot \n\n Column 3 \n Damage + 9',
  'Enjoy!',
  [
    {text: 'T20 = Total D20 Roll includes Arcane Strike \n Haste \n Song', onPress: () => console.log('D20 Roll Total')},
  ...
  handleButtonPress=()=> {
    ...
    let D20TotalS1 = D20S1 + 10 ;
    let D20TotalS2 = D20S2 + 10 ;
    let D20TotalS3 = D20S3 + 10 ;
    let D20TotalS4 = D20S4 + 5 ;
    let D6S1 = Math.floor(Math.random()  * 6) +9;
    let D6S2 = Math.floor(Math.random()  * 6) +9;
    let D6S3 = Math.floor(Math.random()  * 6) +9;
    let D6S4 = Math.floor(Math.random()  * 6) +9;
  ...
  render (){
    ...
    return (
       <ImageBackground source={require('../images/bard5.jpg')} style={styles.container}>
