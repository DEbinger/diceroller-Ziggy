...
export default class ZiggyASHS extends React.Component {
  ...
  handleButtonPress=()=> {
    ...
    let D6S1 = Math.floor(Math.random()  * 6) +24;
    let D6S2 = Math.floor(Math.random()  * 6) +24;
    let D6S3 = Math.floor(Math.random()  * 6) +24;
    let D6S4 = Math.floor(Math.random()  * 6) +24;
       ...
       <ScrollView style={styles.bard3}>
          <View style={styles.top3}>
            <TouchableOpacity onPress={imgClick} style={styles.profileimage}>
              <Image
                style={styles.image}
                source={require('../images/bard3.jpg')}
              />
            </TouchableOpacity>
          </View>
